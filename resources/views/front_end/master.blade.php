...
<body>
                        ...
                        <div class="header__top__inner">
                            ...
                            <div class="header__top__right">
                                ...
                                <div class="header__top__right__cart">
                                    <a href="{{url('/cart')}}"><img src="{{url('/')}}/front_end/img/icon/cart.png" alt=""> <span>0</span></a>
                                    <div class="cart__price">Cart: <span>$0.00</span></div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="{{url('/frontend_contact')}}">Contact</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
   ...
   @yield('content')
    ...
    <footer class="footer set-bg" data-setbg="{{url('/')}}/front_end/img/footer-bg.jpg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{url('/')}}/front_end/img/footer-logo.png" alt=""></a>
                        </div>
